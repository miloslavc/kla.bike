...
function TermsAndConditions() {
  return (
    <>
      ...
      <Wrapper>
        <h2>Welcome to Kla Wooden Handlebars</h2>
        <p>
          These terms and conditions outline the rules and regulations for the
          use of Kla Wooden Handlebars's Website.
        </p>
        <br />
        <span> Kla Wooden Handlebars</span> is located at:
        <br />
        <address>
          <br />
        </address>
        <p>
          ...
          conditions in full. Do not continue to use Kla Wooden Handlebars's
        ...
        <h2>Cookies</h2>
        <p>
          We employ the use of cookies. By using Kla Wooden Handlebars's website
          you consent to the use of cookies in accordance with Kla Wooden
          Handlebars's privacy policy.
        </p>
        <p>
        ...
        <h2>License</h2>
        <p>
          Unless otherwise stated, Kla Wooden Handlebars and/or it's licensors
          own the intellectual property rights for all material on Kla Wooden
          Handlebars. All intellectual property rights are reserved. You may
          view and/or print pages from https://www.kla.bike for your own
          personal use subject to restrictions set in these terms and
          conditions.
        </p>
        <p>You must not:</p>
        <ol>
          <li>Republish material from https://www.kla.bike</li>
          <li>Sell, rent or sub-license material from https://www.kla.bike</li>
          <li>
            Reproduce, duplicate or copy material from https://www.kla.bike
          </li>
        </ol>
        <p>
          Redistribute content from Kla Wooden Handlebars (unless content is
        ...
        <p>
          ...
          outweighs the absence of $companyName; and (d) where the link is in
        ...
        <p>
          ...
          e-mail to{" "}
          <a
            href="mailto:conatct@kla.bike"
            title="send an email to conatct@kla.bike"
          >
            conatct@kla.bike
          </a>
        ...
        <p>
          No use of Kla Wooden Handlebars's logo or other artwork will be
