    ...
    <>
      ...
      <Wrapper>
        ...
        <p>
          ...
          <a href="https://www.kla.bike">https://www.kla.bike</a> (hereinafter,
          "us", "we", or "https://www.kla.bike"). We respect your privacy and
        ...
        <p>
          Like most website operators, Kla Wooden Handlebars collects
          non-personally-identifying information of the sort that web browsers
          and servers typically make available, such as the browser type,
          language preference, referring site, and the date and time of each
          visitor request. Kla Wooden Handlebars's purpose in collecting
          non-personally identifying information is to better understand how Kla
          Wooden Handlebars's visitors use its website. From time to time, Kla
          Wooden Handlebars may release non-personally-identifying information
          in the aggregate, e.g., by publishing a report on trends in the usage
          of its website.
        </p>
        <p>
          Kla Wooden Handlebars also collects potentially personally-identifying
          information like Internet Protocol (IP) addresses for logged in users
          and for users leaving comments on https://www.kla.bike blog posts. Kla
          Wooden Handlebars only discloses logged in user and commenter IP
          addresses under the same circumstances that it uses and discloses
          personally-identifying information as described below.
        </p>
        <h2>Gathering of Personally-Identifying Information</h2>
        <p>
          Certain visitors to Kla Wooden Handlebars's websites choose to
          interact with Kla Wooden Handlebars in ways that require Kla Wooden
          Handlebars to gather personally-identifying information. The amount
          and type of information that Kla Wooden Handlebars gathers depends on
          the nature of the interaction. For example, we ask visitors who sign
          up for a blog at https://www.kla.bike to provide a username and email
          address.
        </p>
        <h2>Security</h2>
        <p>
        ...
        <p>
          ...
          interest to you. This Privacy Policy covers the use of cookies by Kla
          Wooden Handlebars and does not cover the use of cookies by any
          advertisers.
        </p>
        ...
        <p>
          Kla Wooden Handlebars may collect statistics about the behavior of
          visitors to its website. Kla Wooden Handlebars may display this
          information publicly or provide it to others. However, Kla Wooden
          Handlebars does not disclose your personally-identifying information.
        </p>
        <h2>Cookies</h2>
        <p>
          To enrich and perfect your online experience, Kla Wooden Handlebars
        ...
        <p>
          ...
          website each time the visitor returns. Kla Wooden Handlebars uses
          cookies to help Kla Wooden Handlebars identify and track visitors,
          their usage of https://www.kla.bike, and their website access
          preferences. Kla Wooden Handlebars visitors who do not wish to have
          cookies placed on their computers should set their browsers to refuse
          cookies before using Kla Wooden Handlebars's websites, with the
          drawback that certain features of Kla Wooden Handlebars's websites may
          not function properly without the aid of cookies.
        </p>
        <p>
          By continuing to navigate our website without changing your cookie
          settings, you hereby acknowledge and agree to Kla Wooden Handlebars's
          use of cookies.
        </p>
        <h2>E-commerce</h2>
        <p>
          Those who engage in transactions with Kla Wooden Handlebars – by
          purchasing Kla Wooden Handlebars's services or products, are asked to
          ...
          each case, Kla Wooden Handlebars collects such information only
          insofar as is necessary or appropriate to fulfill the purpose of the
          visitor's interaction with Kla Wooden Handlebars. Kla Wooden
          Handlebars does not disclose personally-identifying information other
        ...
        <p>
          Although most changes are likely to be minor, Kla Wooden Handlebars
          may change its Privacy Policy from time to time, and in Kla Wooden
          Handlebars's sole discretion. Kla Wooden Handlebars encourages
